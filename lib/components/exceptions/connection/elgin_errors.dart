...
///
/// Esta classe interpreta o código de erro retornado pela API nativa e
/// fornece o tipo de erro e uma mensagem descritiva correspondente,
/// facilitando o tratamento e exibição dos erros ao usuário final.
///
/// Exemplo de uso:
/// ```dart
...
class ElginError {
  ...
  ///
  /// Caso não informado, o valor padrão é `999` (erro desconhecido).
  int code = 999;

  /// Tipo categorizado do erro, útil para verificações programáticas.
  ///
  /// Exemplo: `'DISPOSITIVO_NAO_ENCONTRADO'`, `'ERRO_ABERTURA_PORTA'`, etc.
  String type = "";

  /// Mensagem detalhada e amigável referente ao erro ocorrido.
  ///
  /// Útil para exibição em logs ou diretamente para o usuário final.
  String message = "";

  /// Construtor da classe [ElginError].
  ///
  /// Recebe o [code] do erro retornado pela operação e preenche automaticamente
  /// os campos [type] e [message] com base em uma tabela interna de erros conhecidos.
  ElginError(this.code) {
    switch (code) {
      ...
      case -3:
        ...
        message =
            'Modelo de impressora informado é inválido ou não é suportado nesta versão.';
        break;
      case -4:
      ...
      // --- Erros de conexão serial ---
      case -11:
        type = 'BAUDRATE_INVALIDO';
        message = 'O baudrate informado é inválido para conexão.';
        break;
      case -12:
      ...
      // --- Erros de escrita na impressora ---
      case -41:
      ...
      // --- Erros de leitura da impressora ---
      case -81:
      ...
      // --- Erros ao abrir gaveta ---
      case -121:
        type = 'PINO_INVALIDO';
        message = 'Indicação de pino inválida.';
        break;
      case -122:
        type = 'TEMPO_INVALIDO';
      ...
      case -132:
        type = 'SCALA_INVALIDA';
        message = 'Escala está fora dos limites. Valor de 1 ou 2.';
        break;
      ...
      case -93:
        ...
        message = 'Função não pode reconhecer os dados enviados.';
        break;
      case -94:
      ...
      case -103:
        ...
        message =
            'Tipo de emissão não encontrada no XML. Valor referente à TAG tpEmis do XML, utilizado para imprimir cupom em contingência.';
        break;

      // --- Erro padrão/desconhecido ---
      case -9999:
      default:
